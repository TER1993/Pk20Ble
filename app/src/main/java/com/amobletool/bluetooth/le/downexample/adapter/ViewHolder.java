...
public class ViewHolder {
    ...
    public ViewHolder setOnCheckChangeListener(int viewId, CompoundButton.OnCheckedChangeListener onCheckedChangeListener) {
...
//        checkBox.setClickable(false);
    ...
    public ViewHolder setFocusable(int viewId, boolean isChecked) {
        CheckBox checkBox=getView(viewId);
